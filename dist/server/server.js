...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-C65SAJaX.js");
...
var manifest = { "211a164bd01296f8668d8c5bebd213e27aa2eac1f774dd5f5e3ed6e090aa4c97": {
	functionName: "submitContactForm_createServerFn_handler",
	importer: () => import("./assets/contact-action-DC44NCNh.js")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-COoqOUtG.js"),
