import { ArrowUpCircle, Briefcase, Building2, Car, GraduationCap, HardHat, Home, Landmark, Repeat, Stethoscope, User } from "lucide-react";
//#region src/lib/mock-data.ts
var advisor = {
	name: "Ashish Garg",
	shortName: "Ashish",
	role: "Loan Advisor & DSA Partner",
	tagline: "Trusted Loan Advisor helping you get the right loan with the right guidance.",
	subtag: "From document review and eligibility check to bank matching and disbursal coordination — end-to-end loan assistance you can rely on.",
	phone: "+91 9779610430",
...
var services = [
	{
		...
		description: "End-to-end assistance for purchase, construction, plot + construction, and home improvement loans with the lowest rate match across partner banks.",
		forWho: [
	...
	},
	{
		...
		description: "Quick disbursal personal loans up to ₹40 lakhs with flexible tenure and pre-approved offers from leading private banks and NBFCs.",
	...
	},
	{
		...
		description: "Unsecured & secured business loans for MSMEs, traders, manufacturers and professionals. Overdraft, term loan, and machinery finance.",
		forWho: [
			"Proprietors & partnerships",
			"Pvt Ltd companies",
			"Professionals (CA/Doctors)"
		],
		eligibility: [
	...
	},
	{
		...
		description: "Mortgage your owned property to raise large-ticket funds for business, education or debt consolidation at attractive long-tenure rates.",
		forWho: [
			"Property owners",
	...
	},
	{
		...
		description: "Pre-approved car loan offers with same-day sanction and dealership coordination across major manufacturers and pre-owned platforms.",
		forWho: [
			"First-time buyers",
			"Used car buyers",
	...
	},
	{
		...
		description: "Reduce EMI burden with rate negotiation across lenders. We compare 15+ banks to find the best switch for your home or LAP.",
		forWho: [
			"Existing home loan borrowers",
			"LAP borrowers",
			"High-rate legacy loans"
		],
		eligibility: [
	...
	},
	{
		...
		description: "Quick top-up on running home loan or LAP with same-rate or marginal-rate pricing — ideal for renovation or business top-up.",
		forWho: [
	...
	},
	{
		...
		description: "End-to-end assistance for undergraduate, postgraduate and study-abroad loans with moratorium-period structuring across leading lenders.",
		forWho: [
			"UG / PG aspirants",
	...
	},
	{
		...
		description: "Plot-plus-construction and pure construction loans with valuation-linked tranches and architect-coordinated disbursal schedules.",
		forWho: [
			"Plot owners",
	...
	},
	{
		...
		description: "Unsecured loans for clinic setup, equipment, chamber expansion or working capital — priced on profession-specific underwriting.",
		forWho: [
			"Doctors & dentists",
	...
	},
	{
		...
		description: "Large-ticket mortgage loans with structured repayment, overdraft variants and lease-rental discounting for commercial property owners.",
		forWho: [
			"Property owners",
			"Business expansion",
...
var stats = [
	...
	{
		label: "Loans Successfully Disbursed",
		value: 1450,
		suffix: "+"
	},
	{
		label: "Max Single Loan Arranged",
		value: 12,
		suffix: " Cr"
	},
	{
		label: "Total Loan Value Facilitated",
		value: 850,
		suffix: " Cr+"
	},
	{
...
var testimonials = [
	{
		...
		amount: "₹ 1.25 Cr",
		rating: 5,
		review: "Ashish made our first home purchase effortless. He compared three banks, negotiated a 0.35% lower rate and handled every document himself.",
	...
	},
	{
		...
		amount: "₹ 45 Lakhs",
		rating: 5,
		review: "We were rejected twice on our own. Ashish restructured our financials presentation and got us a collateral-free working capital line.",
	...
	},
	{
		...
		amount: "₹ 3.10 Cr",
		rating: 5,
		review: "Genuine advisor — no hidden charges, no false promises. The legal & technical coordination on our commercial property was outstanding.",
	...
	},
	{
		...
		amount: "₹ 78 Lakhs",
		rating: 5,
		review: "Switched our home loan and saved ~₹14 lakhs in interest over the remaining tenure. Process was completely paper-light.",
	...
	},
	{
		...
		amount: "₹ 18 Lakhs",
		rating: 5,
		review: "Needed emergency funds for a medical situation. Disbursed in 36 hours with full transparency on charges and EMI.",
	...
	},
	{
		...
		amount: "₹ 62 Lakhs",
		rating: 5,
		review: "As a self-employed consultant my profile was complex. Ashish picked the right NBFC and got me a better rate than my own banker offered.",
...
var processSteps = [
	{
		title: "Consultation",
		description: "Share your requirement on call or WhatsApp. We understand your goal, income profile and timeline."
	},
	{
		title: "Eligibility Review",
		description: "Detailed eligibility check across 28+ partner banks and NBFCs based on your income, credit and profile."
	},
	{
		title: "Document Verification",
		description: "A personalised document checklist, format review and pre-submission verification — no surprises later."
	},
	{
		title: "Submission to Partner Institutions",
		description: "We shortlist 2–3 best-fit lenders, file your application and coordinate legal & technical clearances."
	},
	{
		title: "Approval & Disbursal",
		description: "Sanction letter, disbursal coordination, EMI setup and lifetime guidance on top-ups or balance transfers."
	}
];
var reasonsToChoose = [
	{
...
var caseStudies = [
	{
		...
		challenge: "Self-employed applicant rejected by 2 banks due to inconsistent ITR pattern.",
		solution: "Restructured income presentation, matched profile to an NBFC specialising in self-employed underwriting.",
	...
	},
	{
		...
		challenge: "Trading business needed ₹45L unsecured for a new warehouse — declined twice on own application.",
		solution: "Re-presented financials to 3 lenders, negotiated collateral-free OD with flexible drawdown.",
	...
	},
	{
		...
		challenge: "Existing home loan running at 9.55% — ₹78L outstanding, 14 years left.",
		solution: "Negotiated rate-match across 4 banks; handled documentation and lien transfer end-to-end.",
	...
	},
	{
		...
		challenge: "Owner needed ₹3.1 Cr against commercial unit with complex title chain.",
		solution: "Coordinated legal & technical, structured tranche disbursal, locked a 9.10% rate.",
...
//#endregion
export { partners as a, services as c, timeline as d, navLinks as i, stats as l, caseStudies as n, processSteps as o, faqs as r, reasonsToChoose as s, advisor as t, testimonials as u };
